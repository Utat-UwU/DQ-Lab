...
ani = PembersihData("Ani", usia = 25)
budi = DokumenterTeknis("Budi", usia = 18)
cici = IlmuwanData("Cici")
didi = IlmuwanData("Didi", usia = 32, pendapatan = 20000000)
efi = AnalisData("Efi")
febi = AnalisData("Febi", usia = 28, pendapatan = 12000000)
